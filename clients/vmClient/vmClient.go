...
import (
	...
	"github.com/IMQS/azure-sdk-for-go/clients/hostedServiceClient"
	"github.com/IMQS/azure-sdk-for-go/clients/imageClient"
	"github.com/IMQS/azure-sdk-for-go/clients/locationClient"
	"github.com/IMQS/azure-sdk-for-go/clients/storageServiceClient"
)
...
func SetAzureDockerVMExtension(azureVMConfiguration *Role, dockerPort int, version string) (*Role, error) {
	...
	azureVMConfiguration, err = SetAzureVMExtension(azureVMConfiguration, "DockerExtension", "IMQS.Extensions", version, "DockerExtension", "enable", publicConfiguration, privateConfiguration)
	return azureVMConfiguration, nil
}
